...
fire.Color = 255, 255, 255
fire.Heat = 25
fire.SecondaryColor = 255, 255, 255
fire.Size = 2 
...
adminlist = {"Venomux", "hiphiphortsnort"}--Add in the names of the people you want to be able to use the command script here.
...
--If theres anything you think this command script needs, just message me (Person299)
 --and i might put it in. :)
